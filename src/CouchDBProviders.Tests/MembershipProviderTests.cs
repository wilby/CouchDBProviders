...
namespace CouchDBProviders.Tests
{
    ...
    public class MembershipProviderTests : TestBase
    {
        ...
        private CouchDBProviders.MembershipProvider _provider;
        ...
        public void SetUp() {
            ...
            _provider = new CouchDBProviders.MembershipProvider();
            var config = GetMembershipConfigFake();
            _provider.Initialize("CouchDBProviders", config);
        ...
        {
            var provider = new CouchDBProviders.MembershipProvider();
            var config = GetMembershipConfigFake();
